...
import com.jozzee.mysurvey.asynctask.RequestSurveyForm;
...
import com.jozzee.mysurvey.support.TestActivity;
...
public class SurveyPublicFragment extends Fragment {
    private static String TAG = SurveyPublicFragment.class.getSimpleName();
    ...
    public static SurveyPublicFragment newInstance(int accountID, int typeOffRecycleView) {
        SurveyPublicFragment fragment = new SurveyPublicFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {  Log.i(TAG, "onCreateView");
        ...
        adapter.setOnLoadMoreListener(new OnLoadMoreListener() {
            @Override
            public void onLoadMore() { Log.i(TAG, "onLoadMore");

                if (!allSurvey) { Log.i(TAG, "allSurvey false");
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() { Log.i(TAG, "onRefresh");
        ...
        layoutNotHaveSurvey.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new RequestSurveyFormTask(false).execute("1","1", "20");
            }
        });
        retry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent profileIntent = new Intent(v.getContext(), ProfileActivity.class);
                ...
                accountDataBean.setAccountID(12);
                accountDataBean.setName("Ohmming");
                accountDataBean.setEmail("masters_lock@hotmail.com");
                accountDataBean.setPassword("123456");
    ...
    @Subscribe
    public void onSetTypeRecycleView(OnSetTypeRecycleViewEvent event){ Log.i(TAG,"onSetTypeRecycleView");
        typeOffRecycleView = event.getTypeOffRecycleView();
        adapter.setTypeOffRecycleView(typeOffRecycleView);
        FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
        fragmentTransaction.detach(this).attach(this).commit(); //refresh fragment
    }
    ...
    private class RefreshSurveyFromTask extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected String doInBackground(String... params) { Log.i(TAG, "doInBackground");
            String url = support.getURLLink() +"?command=RefreshSurveyFrom&surveyType=1&lastDate=" +params[0];
            return new ConnectionServiceCore().doOKHttpGetString(url);
        }
        @Override
